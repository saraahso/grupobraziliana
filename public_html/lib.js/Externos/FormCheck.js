...
var FormCheck = new Class({
	...
	options : {
		...
		alerts : {
			...
			alpha: "Apenas caracteres alfabeticos sao aceitos.",
			alphanum: "Apenas caracteres Alfa-numericos aceitos.",
			nodigit: "Digitos nao sao aceitos.",
			...
			email: "Introduza um e-mail valido: <br /><span>p.e. n...@dominio.com.br</span>",
			phone: "Introduza um telefone valido.",
			url: "Introduza um URL valido: <br /><span>p.e. http://www.dominio.com.br</span>",
			
			confirm: "Este campo e diferente de %0",
			...
			lengthmax: "Tamanho incorreto, tem de ser no maximo %0",
			lengthmin: "Tamanho incorreto, tem de ser no minimo %0",
			checkbox: "Confirme a opcao",
			radios: "Selecione uma opcao",
	...
	*/
	addError : function(obj) {
		...
		if (obj.element && obj.element != true) {
			...
			obj.element.setStyle('z-index', 99);
