...
class ListaNoticias extends Lista {
	...
	public function inserir(Noticia &$t){
		...
		$this->con->executar("INSERT INTO ".Sistema::$BDPrefixo.$this->tabela."(".parent::URL.", ".parent::TEXTO.", ".self::DATA.") VALUES('".$t->getURL()->getId()."','".$t->getTexto()->getId()."','".$t->getData()->mostrar("Ymd")."')");
